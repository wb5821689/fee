...
public class WSGLWebServiceFacadeSrvProxyServiceLocator
		extends org.apache.axis.client.Service
		implements WSGLWebServiceFacadeSrvProxyService {
    ...
    private java.lang.String WSGLWebServiceFacade_address = "http://win-7forugvlu01:6888/ormrpc/services/WSGLWebServiceFacade";
	...
	public WSGLWebServiceFacadeSrvProxy getWSGLWebServiceFacade(
        ...
        try {
			WSGLWebServiceFacadeSoapBindingStub _stub = new WSGLWebServiceFacadeSoapBindingStub(
					portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
			if (WSGLWebServiceFacadeSrvProxy.class
					.isAssignableFrom(serviceEndpointInterface)) {
				WSGLWebServiceFacadeSoapBindingStub _stub = new WSGLWebServiceFacadeSoapBindingStub(
						new java.net.URL(WSGLWebServiceFacade_address), this);
                _stub.setPortName(getWSGLWebServiceFacadeWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://win-7forugvlu01:6888/ormrpc/services/WSGLWebServiceFacade", "WSGLWebServiceFacadeSrvProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://win-7forugvlu01:6888/ormrpc/services/WSGLWebServiceFacade", "WSGLWebServiceFacade"));
        }
