...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service
	...
	public EASLoginProxy getEASLogin(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
        try {
			EASLoginSoapBindingStub _stub = new EASLoginSoapBindingStub(
					portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
			if (EASLoginProxy.class
					.isAssignableFrom(serviceEndpointInterface)) {
				EASLoginSoapBindingStub _stub = new EASLoginSoapBindingStub(
						new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }
